            ...
            <div class="mt-10 flex flex-col items-center">
                ...
                <div class="w-full flex-1 mt-8">
                    <div class="mx-auto max-w-xs">
                        ...
                        <button
                            class="mt-5 tracking-wide font-semibold bg-black text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
