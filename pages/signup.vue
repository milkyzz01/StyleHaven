            ...
            <div class="mt-10 flex flex-col items-center">
                ...
                <div class="w-full flex-1 mt-8">
                    <div class="mx-auto grid grid-cols-2 gap-5">
                        <input
                            class="w-full col-span-2 px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 mt-1 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
